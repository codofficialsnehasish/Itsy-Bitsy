		            ...
		            <div class="card mt-4 mb-4 mb-xl-0">
		                ...
		                <div class="card-body">
							<ul class="nav flex-column bg-light h-100 dashboard-list" role="tablist">
                                ...
                                <li><a class="nav-link" href="<?= base_url("my-dashboard/wishlist"); ?>">Wishlist</a></li>
			            	...
			            	<div id="dashboard" class="tab-pane fade active show">
                                ...
                                <div class="row user-profile mt-4">
                                    <div class="col-12 col-lg-12">
                                        <ul class="profile-order mt-3 mt-lg-0" style="display: flex;justify-content: space-between;">
                                            <li>
                                                <h3 class="mb-1" style="text-align: center;"><?= get_any_orders_count($this->user_id,'all');?></h3>
                                                All Orders
                                            </li>
                                            <li>
                                                <h3 class="mb-1" style="text-align: center;"><?= get_any_orders_count($this->user_id,1);?></h3>
                                                Order Completed 
                                            </li>
                                            <li>
                                                <h3 class="mb-1" style="text-align: center;"><?= get_any_orders_count($this->user_id,2);?></h3>
                                                Cancelled Orders
                                            </li>
                                            <li>
                                                <h3 class="mb-1" style="text-align: center;"><?= get_any_orders_count($this->user_id,'pending');?></h3>
                                                Active Orders
                                            </li>
                                        </ul>
                                    </div>
