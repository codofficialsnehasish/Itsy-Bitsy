<div class="page-content">
   	<div class="container-fluid">
      	...
      	<!-- end page title -->
      	<?= form_open_multipart('admin/coupons/update_process', 'class="custom-validation"');?>
         	<div class="row">
            	<div class="col-lg-9">
            		<div class="card">
               			<div class="card-body">
                           			...
                           			<div class="row">
										<input type="hidden" name="coupons_id" value="<?= $item->id; ?>">
                     					<div class="mb-3">
                     					   	...
                     					   	<div>
                     					      	<input data-parsley-type="text" id="cpcode" type="text" class="form-control" required placeholder="Coupon Code" name="cpcode" value="<?= $item->coupons_code ?>">
                     					   	</div>
											<div class="pt-2">
										...
										<div class="mb-3">
											...
											<div>
												<textarea name="desc"  class="form-control editor" rows="1"><?= $item->description; ?></textarea>
											</div>
										</div>
										<!-- <div class="mb-3">
