<div class="page-content">
   <div class="container-fluid">
         ...
         <div class="row align-items-center">
            <div class="col-md-8">
               ...
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item"><a href="<?= admin_url('collection')?>">Collection</a></li>
            ...
            <div class="col-md-4">
               <div class="float-end d-none d-md-block">
                  <div class="dropdown">
                     <a href="<?= admin_url('collection/')?>" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
      ...
      <!-- end page title -->
      <?= form_open_multipart('admin/collection/update-process', 'class="custom-validation"');?>
            ...
            <?php $this->load->view('admin/partials/_edit-input-image');?>
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <!-- <div class="mb-3">
                        <label class="form-label mb-3 d-flex">Popular Collections</label>
                        <div class="form-check form-check-inline">
                      ...
                      <!-- <div class="mb-3">
                        <label class="form-label mb-3 d-flex">Special Collections</label>
                        <div class="form-check form-check-inline">
